...
def get_chaves_dicts_str(tipo: str) -> str: #chaves hardcoded
    ...
    Returns:
        str: chaves separadas por ponto e vírgula
    """
    chaves_por_tipo = {
        ...
        'Cota': (
            ...
            "Cota_05;Cota_05_Status;Cota_06;Cota_06_Status;Cota_07;Cota_07_Status;Cota_08;Cota_08_Status;Cota_09;"
            "Cota_09_Status;Cota_10;Cota_10_Status;Cota_11;Cota_11_Status;Cota_12;Cota_12_Status;Cota_13;"
            "Cota_13_Status;Cota_14;Cota_14_Status;Cota_15;Cota_15_Status;Cota_16;Cota_16_Status;Cota_17;Cota_17_Status;"
            "Cota_18;Cota_18_Status;Cota_19;Cota_19_Status;Cota_20;Cota_20_Status;Cota_21;Cota_21_Status;Cota_22;"
            "Cota_22_Status;Cota_23;Cota_23_Status;Cota_24;Cota_24_Status;Cota_25;Cota_25_Status;Cota_26;Cota_26_Status;"
            "Cota_27;Cota_27_Status;Cota_28;Cota_28_Status;Cota_29;Cota_29_Status;Cota_30;Cota_30_Status;Cota_31;"
            "Cota_31_Status;Data_Hora_Dado;Data_Ultima_Alteracao;Dia_Maxima;Dia_Minima;Maxima;Maxima_Status;Media;"
            "Media_Anual;Media_Anual_Status;Media_Status;Mediadiaria;Minima;Minima_Status;Tipo_Medicao_Cotas;"
        ...
        'Chuva': (
            ...
            "Chuva_05;Chuva_05_Status;Chuva_06;Chuva_06_Status;Chuva_07;Chuva_07_Status;Chuva_08;Chuva_08_Status;Chuva_09;"
            "Chuva_09_Status;Chuva_10;Chuva_10_Status;Chuva_11;Chuva_11_Status;Chuva_12;Chuva_12_Status;Chuva_13;Chuva_13_Status;"
            "Chuva_14;Chuva_14_Status;Chuva_15;Chuva_15_Status;Chuva_16;Chuva_16_Status;Chuva_17;Chuva_17_Status;"
            "Chuva_18;Chuva_18_Status;Chuva_19;Chuva_19_Status;Chuva_20;Chuva_20_Status;Chuva_21;Chuva_21_Status;Chuva_22;"
            "Chuva_22_Status;Chuva_23;Chuva_23_Status;Chuva_24;Chuva_24_Status;Chuva_25;Chuva_25_Status;Chuva_26;Chuva_26_Status;"
            "Chuva_27;Chuva_27_Status;Chuva_28;Chuva_28_Status;Chuva_29;Chuva_29_Status;Chuva_30;Chuva_30_Status;Chuva_31;"
            "Chuva_31_Status;Data_Hora_Dado;Data_Ultima_Alteracao;Dia_Maxima;Maxima;Maxima_Status;Nivel_Consistencia;Numero_Dias_de_Chuva;"
            "Numero_Dias_de_Chuva_Status;Tipo_Medicao_Chuvas;Total;Total_Anual;Total_Anual_Status;Total_Status;codigoestacao"
        )
    }

    return chaves_por_tipo.get(tipo, '')

def get_chaves_dicts(tipo) -> list:
    """Retorna uma lista das chaves dos dicionarios de cada tipo de estacao."""
    chaves = {
        'Adotada': ['Hora_Medicao', 'Chuva_Adotada', 'Cota_Adotada', 'Vazao_Adotada'],
        'Detalhada': ['Hora_Medicao', 'Chuva_Acumulada', 'Chuva_Adotada', 'Cota_Adotada', 'Cota_Sensor', 'Vazao_Adotada'],
        'Sedimentos': [
...
def cria_arquivo_resultado(pathArquivo, tipo):
    """Cria um arquivo com o cabeçalho de um tipo de estação

    Args:
        pathArquivo str: Caminho com o nome do arquivo
        tipo str: Tipo da estação, e consequentemente do cabeçalho
    """
    with open(pathArquivo, 'w') as f:
        chaves =get_chaves_dicts_str(tipo)+'\n' 
        f.write(chaves)

def atualizar_arquivo_resultado(pathArquivo, listaDados, tipo):
    """Realiza o append de dados em um arquivo de estação.

    Args:
        pathArquivo str: path do arquivo a ser modificado
        listaDados list: Lista de dicionarios com os valores a serem adicionados
        tipo str: Tipo da estacao a ter seu arquivo atualizado
    """
    with open(pathArquivo, 'a') as f:
        listaChaves = get_chaves_dicts(tipo)
        
        formato = ('{};' * len(listaChaves)+'\n')

        for item in listaDados:
            valores = [str(item[chave]) for chave in listaChaves] 
            linha = formato.format(*valores) #passa os valores da lista, nao a lista
            f.write(linha)       
...
def atualiza_credenciais_ana(pathConfigs: str, dados: dict)->None:
    ...
    with open(pathConfigs, "r+") as f:
        dataArqStr = f.read()

        dataJson = json.loads(dataArqStr)
        dataJson.update({"Credenciais":{"Ana":{"Identificador":dados['id'], "Senha":dados['senha']}}})

    #arq.read() faz o ponteiro ir para o final do arquivo, sendo necessário voltar pro começo para sobre-escrever as modificações
        f.seek(0)
...
def cria_log(exception, traceback, dir):
    os.makedirs(dir, exist_ok=True)

    with open(f'{dir}\\log-{(datetime.now()).strftime('%Y-%m-%d %H-%M-%S')}.txt', 'w') as file:
